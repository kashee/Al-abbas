...
<div id="right-panel" class="right-panel"> 
  ...
  <div class="container">
   ...
   if (isset($_POST["Submit"])) {
	...
	$subcommitte_id = 1;//$_POST['subcommitte_id'];
	$title = $_POST['title'];
  ...
  <div class="form-group row">
     ...
     <div class="col-sm-9">
      <input type="text" class="form-control" name="title" placeholder="Enter title" style="width:70%" >
    </div>
  </div>
  ...
  <div class="form-group row">
     ...
     <div class="col-sm-9">
      <textarea name="description"  class="form-control" style="width:70%" ></textarea>
    </div>
  </div>
