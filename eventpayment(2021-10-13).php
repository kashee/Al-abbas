...
$next_page = $page_no + 1;
$adjacents = "2";
$result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `paymentinfo`");
...
<head>
    ...
    <title>Event Payment List | Admin</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>                      
                                <?php
								$t = $offset+1;
                                $get_category = mysqli_query($conn,"select * from paymentinfo AS p JOIN ksmic_event AS e on p.eventid=e.id ORDER BY p.id DESC LIMIT $offset, $total_records_per_page");
