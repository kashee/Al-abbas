...
if (isset($_REQUEST['imgname'])) {
    unlink(FILE_URL.'footer/'.$_REQUEST['imgname']);
	echo "<script>window.location='homefooter.php';</script>";
	exit;
}

if (isset($_REQUEST['footerimage']) && $_REQUEST['footerimage'] == 'Submit') {
	
   foreach($_FILES['footerimage']['name'] as $key=>$value){
		$imagename = time().'-'.$_FILES['footerimage']['name'][$key];
		$uploadfile = FILE_URL.'footer/'.$imagename;
		$res = move_uploaded_file($_FILES['footerimage']['tmp_name'][$key], $uploadfile);
   }
   echo "<script>window.location='homefooter.php';</script>";
...
<title>Footer Images | Admin</title>
    ...
    <div class="page-header float-right">
      <div class="page-title">
        <ol class="breadcrumb text-right">
          ...
          <li class="active">Footer Images</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data">
		<input type="file" name="footerimage[]" multiple>
		<input type="submit" name="footerimage" value="Submit" class="btn btn-primary">
    </form>
    </div>
</div>    
...
<div class="container">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-4 col-xs-6 thumb" style="text-align:center;"> <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                   data-image="<?=IMAGE_URL.'footer/'.$val;?>"
                   data-target="#image-gallery"> <img class="img-thumbnail"
                         src="<?=IMAGE_URL.'footer/'.$val;?>"
