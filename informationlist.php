                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>                      
								...
								<a target="_blank" href="<?php echo IMAGE_URL.'info/'.$result['document']; ?>"><?php echo $result['doctitle']; ?></a> <?php }?></td>
								<td><?php if($result['video']!=''){ ?>
								<a target="_blank" href="<?php echo $result['video']; ?>">View Video</a> <?php }?></td>
                              
								<td><?php if($result['customvideo']!=''){ ?>
								<a target="_blank" href="<?php echo IMAGE_URL.'info/'.$result['customvideo']; ?>">View Video</a> <?php }?></td>
                                </td> 
                               <td>
